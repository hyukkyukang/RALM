...
from src.dataset.openwebtext.utils import mkdir, chunks, linecount
from src.dataset.openwebtext.scrapers import bs4_scraper, newspaper_scraper, raw_scraper
...
def download(
    ...
    domain = f"{ext.domain}.{ext.suffix}"  # Combines domain and suffix into a full domain name
    meta["domain"] = domain
