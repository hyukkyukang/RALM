...
class ReLlamaTokenizer(PreTrainedTokenizerFast):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

    @classmethod
    def from_pretrained(cls, model_name: str, hf_token: str = None, **kwargs):
        """Convert a pretrained tokenizer to a ReLlamaTokenizer.
        ...
        :rtype: _type_
        """
        tokenizer: AutoTokenizer = call_autotokenizer_with_hf_token(
            model_name=model_name, hf_token=hf_token, **kwargs
        )
